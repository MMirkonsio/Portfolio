...
const columnData = [
  ...
  },
  {
    ...
    description2:
      "Cuenta con un sistema de rondas y resultados a medida que se va ganando, perdiendo o empatando, todo esto enfrentandote a un bot que juega contigo.",
